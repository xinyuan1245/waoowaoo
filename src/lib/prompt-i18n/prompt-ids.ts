export const PROMPT_IDS = {
  ...
  NP_AGENT_STORYBOARD_IMAGE_PROMPT_REFINE: 'np_agent_storyboard_image_prompt_refine',
  NP_AGENT_STORYBOARD_VIDEO_PROMPT_REFINE: 'np_agent_storyboard_video_prompt_refine',
